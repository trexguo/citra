...
public final class EmulationFragment2 extends Fragment implements SurfaceHolder.Callback, Choreographer.FrameCallback {
    ...
    public static EmulationFragment2 newInstance(String gamePath) {
        Bundle args = new Bundle();
        args.putString(KEY_GAMEPATH, gamePath);

        EmulationFragment2 fragment = new EmulationFragment2();
